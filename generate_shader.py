...
def content(c, name = ""):
    image = Image.new("RGBA", (16, 16), (1, 1, 1));
    draw = ImageDraw.Draw(image)
    font = ImageFont.truetype("./arial.ttf", 12)
    draw.text((4, 0), c, font=font)
    ...
    for i in range(0 , 16):
        ...
        for j in range(0, 16):
            ...
            if(j == 15 and white == True): #We have finished and
                endingpoint = j;
                white = False;
                if(contstatus == True):
                    function_content = function_content + "+"
